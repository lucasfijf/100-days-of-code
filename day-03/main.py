...
if answer1 == "left":
    answer2 = input("You've come to a lake. There is an island in the middle of the lake. Type \"wait\" to wait for a boat. Type \"swim\" to swim accross.\n").lower()
    if answer2 == "wait":
